  ...
  return (
    <>
      ...
      <motion.button
        ...
        onClick={() => setOpen((v) => !v)}
        className={cn(
          "fixed bottom-6 right-6 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-[0_16px_40px_rgba(0,0,0,0.55)]",
